...
exports.UnsubscribedEvent = void 0;
/*
 *  Author: Hudson S. Borges
 */
const Fragment_1 = __importDefault(require("../../Fragment"));
const ActorFragment_1 = require("../ActorFragment");
class UnsubscribedEvent extends Fragment_1.default {
    constructor() {
        super(...arguments);
        this.code = "unsubscribedEvent";
    }
    get dependencies() {
...
exports.default = new UnsubscribedEvent();
//# sourceMappingURL=UnsubscribedEvent.js.map