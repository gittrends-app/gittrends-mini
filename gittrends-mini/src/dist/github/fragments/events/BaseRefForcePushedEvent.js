...
exports.BaseRefForcePushedEvent = void 0;
/*
...
class BaseRefForcePushedEvent extends Fragment_1.default {
    constructor() {
        super(...arguments);
        this.code = "baseRefForcePushedEvent";
    }
    get dependencies() {
...
exports.BaseRefForcePushedEvent = BaseRefForcePushedEvent;
exports.default = new BaseRefForcePushedEvent();
//# sourceMappingURL=BaseRefForcePushedEvent.js.map